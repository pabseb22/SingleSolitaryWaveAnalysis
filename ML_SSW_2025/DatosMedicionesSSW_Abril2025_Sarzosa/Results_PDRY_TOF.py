...
# Scatter plot (TOF en eje X, Densidad seca en Y)
scatter = ax.scatter(df['tof'], df['rho_dry'], c=df['humedad'], cmap='viridis_r', s=100, edgecolor='k')
...
# Etiquetas y título
ax.set_xlabel('TOF Promedio (s)', fontsize=14, fontweight='bold')
ax.set_ylabel('Densidad Seca (g/cm³)', fontsize=14, fontweight='bold')
ax.set_title('Base: Densidad Seca vs TOF', fontsize=16, fontweight='bold')

# Fuente de ticks en Times y bold
...
plt.savefig("Base_DensidadSeca_vs_TOF.png", dpi=600)
