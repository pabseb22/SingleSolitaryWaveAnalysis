...
while true
    ...
    if ~isempty(data)
        ...
        global startIndex;
        global endIndex;
        timeBefore = 0.001; % 0.1 seconds before the maximum value
        timeAfter = 0.003; % 0.2 seconds after the maximum value
...
function endButtonCallback(~, ~)
    ...
    global scanData;
    fileName = 'Flex-Pelotazo-Data.mat'; % Specify the file name with .mat extension
    
    % Save the scanData to a file
    save(fileName, 'scanData');
    ...
    timeDifferencesFileName = 'TOF-Data.mat';
    save(timeDifferencesFileName, 'timeDifferences');
