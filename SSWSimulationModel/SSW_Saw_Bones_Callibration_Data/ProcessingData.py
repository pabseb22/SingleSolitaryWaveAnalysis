...
FA91_normalized = FA91_downsampled / second_highest_peak_value

# Find the first highest peak
first_highest_peak_index = np.argsort(peak_values)[-1]
...
plt.plot(t_downsampled, FA91_normalized, label='Processed Data', color='orange', linewidth=2)
...
# downsampled_file_path = 'PCF_30_num_data_v2_processed.xlsx'
