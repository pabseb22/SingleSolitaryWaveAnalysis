...
saveFolderPath = "C:\Users\Juan Pablo V\OneDrive - Universidad San Francisco de Quito\USFQ 2021\Investigaciones\Pastas_Mortero";  % Replace with the actual folder path

% Set the file name here
file_name = 'ref_0p4_187min.mat';
...
while true
    ...
    if ~isempty(data)
        ...
        timeAfter = 0.0062; % 0.2 seconds after the maximum value
